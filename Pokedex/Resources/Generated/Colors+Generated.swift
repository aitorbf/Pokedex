...
extension Theme {
  internal enum Color {
    ...
    internal enum PokemonType {
        ...
        internal static let typeDark = SwiftUI.Color("type-dark")
        ...
        internal static let typeStellar = SwiftUI.Color("type-stellar")
        internal static let typeUnknown = SwiftUI.Color("type-unknown")
    ...
    internal static let pokemonRed = SwiftUI.Color("pokemonRed")
